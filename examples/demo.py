...
def random_projection_rust(gene_trees_file: str, species_tree_file: str, target_dimension: int, seed: int = 0):
    """
    ...
    logger.info("Projected species tree: " + normalize_tree(ts.read_tree_newick(projected_trees.species_tree_to_newick())).newick())
    ...
    swift_trees = [normalize_tree(ts.read_tree_newick(rust_tree_to_newick(str(tree)))) 
...
def random_projection_treeswift(gene_trees_file: str, species_tree_file: str, target_dimension: int, seed: int = 0):
    """
    ...
    gene_tree_objects = [only_topology(ts.read_tree_newick(tree)) for tree in gene_trees]
...
if __name__ == "__main__":
    ...
    swift_trees, swift_stree = random_projection_treeswift(gtrees_file, stree_file, target_dim)
